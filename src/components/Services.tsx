  ...
  const handleDownload = async (url: string, filename: string) => {
    try {
      ...
      if (response.ok) {
        ...
        setToastMessage("Sorry it's in process 😅 Continue browsing through my website.");
      }
    } catch (error) {
      setToastMessage("Sorry it's in process 😅 Continue browsing through my website.");
    }
    ...
    <section ref={sectionRef} id="about" className="py-16 md:py-24 bg-white dark:bg-[#0f0f0f] relative transition-colors duration-500 border-t border-neutral-200 dark:border-neutral-800">
      <AnimatePresence>
        {toastMessage && (
          <motion.div
            ...
            className="fixed bottom-8 left-1/2 z-50 bg-design-black text-white px-6 py-3 rounded-full shadow-lg flex items-center gap-3 whitespace-nowrap"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-6 relative z-10">
        ...
        <div className="flex flex-col items-start mb-12 md:mb-20" data-gsap-service>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-display font-light text-design-black dark:text-white uppercase leading-none flex flex-col items-start">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-start">
           ...
           <ParallaxFloat offset={-20}>
             ...
             className="flex flex-col space-y-8 md:space-y-12 lg:pl-8 md:lg:pl-12 border-l border-neutral-200 dark:border-neutral-800"
           >
              {/* Current Role */}
              <div>
                  <span className="text-[10px] sm:text-xs font-mono uppercase tracking-widest text-design-blue mb-3 block">Current Role</span>
              ...
              {/* Contact */}
              <div>
                  <span className="text-[10px] sm:text-xs font-mono uppercase tracking-widest text-gray-500 mb-3 md:mb-4 block">Connect</span>
