               ...
               return (
                   ...
                   >
                        ...
                        <div className={`w-full md:w-1/2 pl-12 sm:pl-16 md:pl-0 ${isEven ? 'md:pl-24 text-left' : 'md:pr-24 md:text-right'}`}>
                            ...
                            <p className="text-gray-600 font-medium text-xs sm:text-sm leading-relaxed max-w-sm mx-auto md:mx-0 ml-0 md:ml-auto">
                                {event.desc}
                            </p>
                        </div>
        ...
        {selectedEvent && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8">
             ...
             <motion.div 
                ...
                className="relative w-full max-w-6xl bg-white rounded-[2rem] overflow-hidden flex flex-col md:flex-row shadow-2xl z-[110] max-h-[90vh]"
             >
                {/* Close Button */}
                <button 
                    onClick={() => setSelectedEvent(null)}
                ...
                <div className="w-full md:w-2/5 bg-white text-design-black flex flex-col h-full overflow-y-auto">
                            ...
                            <div className="grid grid-cols-1 gap-3 md:gap-4">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <span className="font-mono text-sm">ARCH-{selectedEvent.year}-{Math.floor(Math.random() * 8999) + 1000}</span>
                                    </div>
                                </div>
