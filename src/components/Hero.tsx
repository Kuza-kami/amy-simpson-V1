...
import { ScrollReveal, ParallaxFloat, BlurReveal } from './TextAnimations';
        ...
        <BlurReveal>
          ...
          >
              ...
              <div className="text-right flex flex-col items-end w-full md:w-auto">
                  <span className="block text-[9px] sm:text-[10px] font-mono uppercase tracking-widest mb-2 text-design-blue">Archive Status</span>
                  <span className="block text-xs sm:text-sm font-bold uppercase tracking-wider">v1.0 Beta // 2025</span>
              </div>
          </motion.div>
        </BlurReveal>
      ...
      <BlurReveal delay={0.2}>
        ...
        >
           <div className="hidden md:flex gap-8 lg:gap-10">
              {['In', 'Be', 'Dr'].map((social) => (
                  <a key={social} href="#" className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider sm:tracking-widest text-gray-400 hover:text-design-blue transition-all">
                      {social}.
                  </a>
              ))}
           </div>
           ...
           >
               <span className="text-[8px] sm:text-[9px] font-mono uppercase tracking-wider sm:tracking-widest mb-2 sm:mb-3 opacity-50">Discover</span>
               <ArrowDown size={16} className="text-design-blue animate-bounce" />
           </div>

           <div className="hidden md:block text-right">
               <div className="flex items-center justify-end gap-3">
                   <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider sm:tracking-widest">Available for hire</span>
